...
def draw_burn_down_chart(daily_stat):
    ...
    plt.bar(x_date + 0.15, new_working_hours, 0.3, alpha=0.85, color='#4783c1', label='new_working_hours')
    plt.bar(x_date + 0.15, new_hours, 0.3, alpha=0.85, color='#c45247', label='new_hours')
    plt.bar(x_date - 0.15, in_daily_working_actual_hours, 0.3, alpha=0.85, color='#61A0A8', label='daily_working_actual_hours')
