...
def test_glob_file_name():
    ...
    assert daily_file_names == ['data\daily-广告平台测试-2017-09-18.txt', 'data\daily-广告平台测试-2017-09-19.txt',
                                'data\daily-广告平台测试-2017-09-20.txt', 'data\daily-广告平台测试-2017-09-21.txt',
                                'data\daily-广告平台测试-2017-09-22.txt']
...
def test_do_compute_cards_stat():
    ...
    check_daily_stat = utils.read_cardinfo_from_json('check_data\check_daily_stat.txt')
